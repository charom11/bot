...
from backtests.strategy_candidate_v9_3_1_shadow_observer_backtest import ReplayConfig, replay_symbol, _dataset_path
...
def test_shadow_replay_returns_structured_result_without_exchange_access():
    ...
    for trade in result.trades:
        ...
        assert trade.setup in {"TREND_CONTINUATION", "BB_ATR_EXPANSION", "MSS_SHIFT", "BREAKOUT_RETEST"}
