...
"""
==========================================================================================
⚡ STRATEGY CANDIDATE V9.3.1: REFINED CONSERVATIVE 15M INTEGRATION INSTITUTIONAL BACKTEST
==========================================================================================
Evaluates Candidate V9.3.1 with:
- Active setups (4): TREND_CONTINUATION, BB_ATR_EXPANSION, MSS_SHIFT, BREAKOUT_RETEST
- Explicitly Gated Setups: VWAP_TREND, PULLBACK_CONTINUATION, LIQUIDITY_SWEEP,
...
- Direct multi-generational comparative evolution: V9 -> V9.1 -> V9.2 -> V9.3 -> V9.3.1
==========================================================================================
"""
...
def run_v9_3_1_institutional_audit(
    cache_dir: str = CACHE_DIR,
    dataset_type: str = "4year",
    friction_r: float = 0.026,
    output_path: str = "backtests/v9_3_1_integration_report.json",
) -> dict:
    t_start = time.time()
    config = V931Config()

    print("=" * 105)
    print(" [AUDIT] STRATEGY CANDIDATE V9.3.1: REFINED CONSERVATIVE 15M INTEGRATION INSTITUTIONAL BACKTEST")
    print("=" * 105)
    print(f" • Dataset Configuration:  15m Resolution ({dataset_type.upper()})")
    print(f" • Active Setups (4):      {sorted(list(ACTIVE_SETUPS_V931))}")
    print(f" • Fully Gated Setups:     {sorted(list(DISABLED_SETUPS_V931))} (VWAP_TREND & PULLBACK pruned)")
    ...
    # -------------------------------------------------------------------------
    print("\n" + "=" * 105)
    print(" [AUDIT 1] CANDIDATE V9.3.1 15M PORTFOLIO BENCHMARK SUMMARY")
    print("=" * 105)
    ...
    print(f" Full V9.3.1 integration audit report saved to: {output_path} (Completed in {time.time()-t_start:.1f}s)")
    print("=" * 105 + "\n")
    return report_data
...
if __name__ == "__main__":
    import argparse
    parser = argparse.ArgumentParser(description="Run Candidate V9.3.1 Refined Integration Backtest")
    ...
    run_v9_3_1_institutional_audit(
